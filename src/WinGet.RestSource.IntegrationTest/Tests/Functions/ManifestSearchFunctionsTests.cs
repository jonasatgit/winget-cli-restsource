...
namespace Microsoft.WinGet.RestSource.IntegrationTest.Tests.Functions
{
    ...
    public class ManifestSearchFunctionsTests
    {
        ...
        private async Task TestSearchFilter(string packageMatchField, string value, string matchType, params string[] expectedPackageIdentifiers)
        {
            ...
            {
                new SearchRequestPackageMatchFilter { PackageMatchField = packageMatchField, RequestMatch = new RestSource.Utils.Models.Objects.SearchRequestMatch { KeyWord = value, MatchType = matchType } },
            };
